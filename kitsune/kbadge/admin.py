...
class AwardAdmin(admin.ModelAdmin):
    list_display = (show_unicode, badge_link, show_image, 'user',
                    'creator', 'created', )
    fields = ('badge', 'description', 'user', 'creator', )
...
for x in ((Badge, BadgeAdmin), (Award, AwardAdmin),):
